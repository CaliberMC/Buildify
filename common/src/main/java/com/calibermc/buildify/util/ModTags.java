...
public class ModTags {
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(new ResourceLocation(Buildify.MOD_ID, name).toString());
        }
        private static TagKey<Block> forgeTag(String name) {
            return BlockTags.create(new ResourceLocation("forge", name).toString());
        }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return ItemTags.bind(new ResourceLocation(Buildify.MOD_ID, name).toString());
        }
